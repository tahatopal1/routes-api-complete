...
@Import({AirportToAirportCalculationStrategy.class})
public class AirportToAirportCalculationStrategyTest {
    ...
    void getCalculationTypeTest() {
        assertThat(routeCalculationStrategy.getCalculationType())
                .isEqualTo(RouteCalculationType.AIRPORT_TO_AIRPORT);
    }
    ...
    void calculateTest() {
        ...
        when(transportationRepository.findRouteAirportToAirport(anyInt(), anyInt(), anyInt()))
