...
@Import({VenueToAirportCalculationStrategy.class})
public class VenueToAirportCalculationStrategyTest {
    ...
    void getCalculationTypeTest() {
        assertThat(routeCalculationStrategy.getCalculationType())
                .isEqualTo(RouteCalculationType.VENUE_TO_AIRPORT);
    }
    ...
    void calculateTest() {
        ...
        when(transportationRepository.findRouteVenueToAirport(anyInt(), anyInt(), anyInt()))
