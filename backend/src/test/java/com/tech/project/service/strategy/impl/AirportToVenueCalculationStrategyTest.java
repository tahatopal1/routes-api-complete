...
@Import({AirportToVenueCalculationStrategy.class})
public class AirportToVenueCalculationStrategyTest {
    ...
    void getCalculationTypeTest() {
        assertThat(routeCalculationStrategy.getCalculationType())
                .isEqualTo(RouteCalculationType.AIRPORT_TO_VENUE);
    }

    @Test
    void calculateTest() {

        when(transportationRepository.findRouteAirportToVenue(anyInt(), anyInt(), anyInt()))
