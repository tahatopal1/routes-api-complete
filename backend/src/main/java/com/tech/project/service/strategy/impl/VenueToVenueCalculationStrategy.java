...
@Service
public class VenueToVenueCalculationStrategy extends RouteCalculationStrategy {

  public VenueToVenueCalculationStrategy(TransportationRepository transportationRepository,
  ...
  public RouteCalculationLogic getCalculationLogic() {
    return transportationRepository::findRouteVenueToVenue;
  }
}
